...
typealias Completion<T, Error: Swift.Error> = (Result<T, Error>) -> Void

protocol APIServiceProtocol {
    func requestAPI<T: Decodable>(request: APIRequest, responseType: T.Type, completion: @escaping Completion<T, NetworkError>)
}
        ...
        let parameters = request.parameters
            Task {
                do {
                    ...
                    let value = try decodeData(data: data, to: T.self)
